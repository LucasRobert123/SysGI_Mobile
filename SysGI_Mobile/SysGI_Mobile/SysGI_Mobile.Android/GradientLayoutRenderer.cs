...
using SysGI_Mobile.Renderers;
using Xamarin.Forms;
using Xamarin.Forms.Platform.Android;

[assembly: ExportRenderer(typeof(GradientLayout), typeof(SysGI_Mobile.Droid.Renderers.GradientLayoutRenderer))]

namespace SysGI_Mobile.Droid.Renderers
{
